        ...
        <div className="grid grid-cols-12 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="col-span-12 lg:col-span-3 space-y-4">
            <div className="flex items-center justify-between px-1">
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">General & Safety (7)</span>
          ...
          <div className="col-span-12 lg:col-span-6 space-y-6">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 group">
              <h3 className="text-[11px] font-black text-slate-500 uppercase mb-6 tracking-[0.2em] group-hover:text-indigo-600 transition-colors">Production Trend (Volume KG)</h3>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 group">
              <h3 className="text-[11px] font-black text-slate-500 uppercase mb-6 tracking-[0.2em] group-hover:text-emerald-600 transition-colors">Product Mix Ratio (%)</h3>
              <div className="h-[320px]">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie
                    ...
                    <Tooltip />
                    <Legend verticalAlign="bottom" iconType="circle" wrapperStyle={{paddingTop: '20px', fontSize: '11px', fontWeight: 700}} />
                  </PieChart>
                </ResponsiveContainer>
              </div>
            </div>
          ...
          <div className="col-span-12 lg:col-span-3 space-y-4">
            <div className="flex items-center justify-between px-1">
              ...
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Production Metrics (8)</span>
            </div>
